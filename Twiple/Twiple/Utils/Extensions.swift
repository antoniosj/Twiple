...
extension UIView {
    func anchor(top: NSLayoutYAxisAnchor? = nil,
        ...
        // if isn't nil so use it.
        if let top = top {
            topAnchor.constraint(equalTo: top, constant: paddingTop).isActive = true
        }
        
        // if you're walking from top to bottom or left to right its a positive value +
        if let left = left {
            leftAnchor.constraint(equalTo: left, constant: paddingLeft).isActive = true
        }
        
        // if you're walking from bottom to top or right to left it's a negative value -
